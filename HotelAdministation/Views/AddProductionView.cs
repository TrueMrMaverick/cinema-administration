...
{
    public partial class AddProductionView : Form, IView<AddProductionViewPresenter>
    {
        public AddProductionView()
        {
            InitializeComponent();
        }

        public AddProductionViewPresenter Presenter { set; get; }
